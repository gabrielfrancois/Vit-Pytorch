...
from configs.train_cifar10 import * from helper_function.print import *
...
def evaluate_model(model, loader, device, model_name="Model"):
    ...
    with torch.no_grad():
        ...
        for imgs, labels in loop:
            ...
            # Forward pass
            # Student returns 4 values, Teacher returns 2. 
            # We only need the first one (logits) for accuracy.
            outputs = model(imgs)
